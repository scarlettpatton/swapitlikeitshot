...
class AppStateNotifier extends ChangeNotifier {
  SwapItLikeItsHotFirebaseUser? initialUser;
  SwapItLikeItsHotFirebaseUser? user;
  ...
  void update(SwapItLikeItsHotFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'inviteUser',
              asyncParams: {
                'item': getDoc('Posts', PostsRecord.serializer),
              },
